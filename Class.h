...
public:
	...
	{
		obj_Player* pLocalPlayer = (obj_Player*)(*(DWORD*)((DWORD)(this) + Localplayer_Adr));

		pLocalPlayer = (obj_Player*)((DWORD)pLocalPlayer ^ 0x0);
